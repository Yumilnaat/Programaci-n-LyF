...
lista_filtrada = list(filter(lambda pelicula: float(pelicula["CalificaciónIMDB"])>8.0, peliculas))

nueva_lista = list(map(lambda pelicula: {"titulo": ["Titulo"], "calificacion": pelicula["CalificaciónIMDB"]}, lista_filtrada))
